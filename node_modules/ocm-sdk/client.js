...
var _Ocm_instances, _a, _Ocm_encoder, _Ocm_baseURLOverridden;
...
const comment_1 = require("./resources/comment.js");
const mediaitem_1 = require("./resources/mediaitem.js");
const openapi_1 = require("./resources/openapi.js");
const poi_1 = require("./resources/poi.js");
const profile_1 = require("./resources/profile.js");
const referencedata_1 = require("./resources/referencedata.js");
...
class Ocm {
     ...
     */
    constructor({ baseURL = (0, env_1.readEnv)('OCM_BASE_URL'), apiKey = (0, env_1.readEnv)('OCM_API_KEY') ?? null, apiKeyHeader = (0, env_1.readEnv)('OCM_API_KEY') ?? null, bearer = (0, env_1.readEnv)('OCM_USERNAME') ?? null, ...opts } = {}) {
        _Ocm_instances.add(this);
        _Ocm_encoder.set(this, void 0);
        this.poi = new API.Poi(this);
        this.referencedata = new API.Referencedata(this);
        this.profile = new API.Profile(this);
        this.comment = new API.Comment(this);
        this.mediaitem = new API.Mediaitem(this);
        this.openAPI = new API.OpenAPI(this);
        const options = {
            apiKey,
            apiKeyHeader,
            bearer,
        ...
        this.logLevel =
            (0, log_1.parseLogLevel)(options.logLevel, 'ClientOptions.logLevel', this) ??
                (0, log_1.parseLogLevel)((0, env_1.readEnv)('OCM_LOG'), "process.env['OCM_LOG']", this) ??
                defaultLogLevel;
        this.fetchOptions = options.fetchOptions;
        this.maxRetries = options.maxRetries ?? 2;
        this.fetch = options.fetch ?? Shims.getDefaultFetch();
        tslib_1.__classPrivateFieldSet(this, _Ocm_encoder, Opts.FallbackEncoder, "f");
    ...
    async authHeaders(opts) {
        return (0, headers_1.buildHeaders)([await this.apiKeyHeaderAuth(opts), await this.userAuthentication(opts)]);
    }
    async apiKeyHeaderAuth(opts) {
        if (this.apiKeyHeader == null) {
            return undefined;
        }
        return (0, headers_1.buildHeaders)([{ 'X-API-Key': this.apiKeyHeader }]);
    }
    async userAuthentication(opts) {
        if (this.bearer == null) {
            return undefined;
        }
        return (0, headers_1.buildHeaders)([{ Authorization: `Bearer ${this.bearer}` }]);
    }
    ...
    buildURL(path, query, defaultBaseURL) {
        const baseURL = (!tslib_1.__classPrivateFieldGet(this, _Ocm_instances, "m", _Ocm_baseURLOverridden).call(this) && defaultBaseURL) || this.baseURL;
    ...
    buildBody({ options: { body, headers: rawHeaders } }) {
        ...
        ArrayBuffer.isView(body) ||
            ...
            return tslib_1.__classPrivateFieldGet(this, _Ocm_encoder, "f").call(this, { body, headers });
        }
    }
}
exports.Ocm = Ocm;
_a = Ocm, _Ocm_encoder = new WeakMap(), _Ocm_instances = new WeakSet(), _Ocm_baseURLOverridden = function _Ocm_baseURLOverridden() {
    return this.baseURL !== 'https://api.openchargemap.io/v3';
};
Ocm.Ocm = _a;
Ocm.DEFAULT_TIMEOUT = 60000; // 1 minute
Ocm.OcmError = Errors.OcmError;
Ocm.APIError = Errors.APIError;
Ocm.APIConnectionError = Errors.APIConnectionError;
Ocm.APIConnectionTimeoutError = Errors.APIConnectionTimeoutError;
Ocm.APIUserAbortError = Errors.APIUserAbortError;
Ocm.NotFoundError = Errors.NotFoundError;
Ocm.ConflictError = Errors.ConflictError;
Ocm.RateLimitError = Errors.RateLimitError;
Ocm.BadRequestError = Errors.BadRequestError;
Ocm.AuthenticationError = Errors.AuthenticationError;
Ocm.InternalServerError = Errors.InternalServerError;
Ocm.PermissionDeniedError = Errors.PermissionDeniedError;
Ocm.UnprocessableEntityError = Errors.UnprocessableEntityError;
Ocm.toFile = Uploads.toFile;
Ocm.Poi = poi_1.Poi;
Ocm.Referencedata = referencedata_1.Referencedata;
Ocm.Profile = profile_1.Profile;
Ocm.Comment = comment_1.Comment;
Ocm.Mediaitem = mediaitem_1.Mediaitem;
Ocm.OpenAPI = openapi_1.OpenAPI;
