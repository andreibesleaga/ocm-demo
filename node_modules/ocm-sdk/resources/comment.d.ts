...
export declare class Comment extends APIResource {
    /**
...
export declare namespace Comment {
    export { type CommentSubmitResponse as CommentSubmitResponse, type CommentSubmitParams as CommentSubmitParams, };
}
