 ...
 */
export declare function executeHandler(tool: Tool, handler: HandlerFunction, client: Ocm, args: Record<string, unknown> | undefined, compatibilityOptions?: Partial<ClientCapabilities>): Promise<import("./tools/types").ToolCallResult>;
