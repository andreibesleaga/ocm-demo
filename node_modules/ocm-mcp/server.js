...
exports.readEnvOrError = exports.readEnv = exports.server = exports.newMcpServer = exports.endpoints = void 0;
...
const ocm_sdk_1 = __importDefault(require("ocm-sdk"));
...
function initMcpServer(params) {
    ...
    const client = new ocm_sdk_1.default(params.clientOptions);
    const capabilities = {
...
function init(params) {
    ...
    const client = params.client || new ocm_sdk_1.default({ defaultHeaders: { 'X-Stainless-MCP': 'true' }, logger: logger });
